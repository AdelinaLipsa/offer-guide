<template>
  <div>
    ...
    <div class="page-content">
      <PageHeader
        badge="STEP 5 OF 8"
        title="Upsell 2: Complementary Product"
        subtitle="Cross-sell a different product that enhances the main purchase"
        :stats="[
          { icon: 'lucide:trending-up', text: '15-30% Accept Rate' },
          { icon: 'lucide:dollar-sign', text: '$37-67 Sweet Spot' },
          { icon: 'lucide:layers', text: 'Different Product' }
        ]"
      />
      ...
      <div class="content-width py-10">
        ...
        <div class="bg-surface border border-border rounded-lg p-4 mb-8 sticky top-4 z-20">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <a href="#pairing" class="nav-pill text-xs px-3 py-1.5 bg-surface-tertiary rounded-md">Product Pairing</a>
            <a href="#pricing" class="nav-pill text-xs px-3 py-1.5 bg-surface-tertiary rounded-md">Pricing</a>
            <a href="#messaging" class="nav-pill text-xs px-3 py-1.5 bg-surface-tertiary rounded-md">Messaging</a>
