<template>
  <div class="hero-header bg-navy-800 text-white py-16 md:py-20">
    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="text-center max-w-3xl mx-auto">
        ...
        <p v-if="subtitle" class="text-lg text-slate-300 mb-6 max-w-2xl mx-auto">
          {{ subtitle }}
        </p>
        <div v-if="badges && badges.length" class="flex justify-center gap-3 flex-wrap">
          <span
            ...
            :key="index"
            class="bg-white/10 text-white px-4 py-2 rounded-md text-sm font-medium border border-white/20"
          >
            {{ badge }}
          </span>
        </div>
